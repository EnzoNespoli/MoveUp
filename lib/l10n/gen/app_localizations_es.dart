...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get onb1_body =>
      'Lleva un registro de cómo te mueves, todo en un solo lugar.';
  ...
  String get onb2_body =>
      'Tu día visto por tu movimiento: cuándo te paras, cuándo te mueves despacio y cuándo vas rápido.';
  ...
  String get onb3_body =>
      'Informes y tendencias automáticos: entiende cómo te mueves. Día tras día.';
  ...
  @override
  String get botton_prosegui => 'Iniciar seguimiento ahora';
  ...
  String get errore_004 =>
      'Servicio de ubicación deshabilitado en el dispositivo';
  ...
  String get gps_err01 =>
      'Seguimiento GPS desactivado: actívalo en la configuración.';
  ...
  String get gps_err03 =>
      'Seguimiento GPS desactivado: la ubicación no se está registrando.';
  ...
  String get gps_err13 =>
      'Debes activar el consentimiento de seguimiento GPS en la configuración';
  ...
  String get info_mes07 =>
      'Entiende cómo te mueves,\nDescubre adónde va tu tiempo.';
  ...
  String get form_reg_err04 =>
      '¡Registro exitoso! Verifica tu correo y podrás iniciar sesión.';
  ...
  String get password_controllo =>
      'La contraseña debe tener al menos 8 caracteres e incluir una letra mayúscula y un número';
  ...
  String get inserisci_mail =>
      'Introduce tu correo electrónico para recibir el enlace de restablecimiento.';
  ...
  String get form_consensi_02 =>
      'Consiento el tratamiento de datos (privacidad)';

  @override
  String get form_consensi_03 =>
      'Consiento recibir comunicaciones de marketing';
  ...
  String get storico_01 =>
      'Elige cuánto historial quieres conservar. El resto crece contigo.';
  ...
  String get dashboard_msg =>
      'Crea una cuenta (gratuita) para guardar tus datos y desbloquear la función de compartir.';
  ...
  String get imposta_page_lista =>
      'Estudiante,Empleado,Profesional,Desempleado,Jubilado,Otro';
  ...
  String get footer_page_diritti =>
      '© 2025 MoveUP - Todos los derechos reservados';
  ...
  String get msg_abilitato_02 =>
      'Cronología disponible con BASIC. Regístrate primero.';
  ...
  String get escl_prog_02 =>
      'Exclusiones disponibles solo a partir del plan Basic';
  ...
  String get verifica_mail_testo2 =>
      'Cuando hayas verificado, vuelve a la página de inicio de sesión para acceder.';
  ...
  String get insight_quality =>
      'Estamos perdiendo datos por el ahorro de batería. Toca para corregirlo.';
  ...
  String get fix_message =>
      'Corrige estos puntos para evitar pérdida de datos.';
  ...
  String get fix_vendor_01 =>
      'MIUI: Seguridad → Permisos → Inicio automático + Ahorro de batería.';

  @override
  String get fix_vendor_02 =>
      'EMUI: Ajustes → Batería → Inicio de apps (permitir inicio y ejecución en segundo plano).';

  @override
  String get fix_vendor_03 =>
      'ColorOS/Funtouch: Habilita Inicio automático y quita la optimización agresiva.';

  @override
  String get fix_vendor_04 =>
      'OnePlus: Batería → Optimización de batería → MoveUP → No optimizar.';

  @override
  String get fix_vendor_05 =>
      'Samsung: Cuidado del dispositivo → Batería → Apps en suspensión: elimina MoveUP.';

  @override
  String get fix_vendor_06 =>
      'Revisa el Inicio automático y la protección de apps del fabricante.';

  @override
  String get fix_messag_01 =>
      'Ve a Ajustes → Privacidad y seguridad → Ubicación → MoveUP\nestablece “Siempre” y activa “Ubicación precisa”.\nRevisa también Ahorro de energía: podría limitar la actividad en segundo plano.';
  ...
  String get dedica_testo =>
      'Mi esposa y Lova, que me dieron la fuerza para llegar hasta aquí. 💚🐾';
  ...
  String get dati_incompleti =>
      'Datos incompletos: el teléfono no ha registrado durante aproximadamente';
  ...
  String get buona_attivita =>
      'Buena actividad, has aprovechado bien parte del día.';
