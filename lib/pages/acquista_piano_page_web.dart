...
class AcquistaPianoPageWeb extends StatefulWidget {
  final String utenteId;
  final Map<String, dynamic> piano;

  const AcquistaPianoPageWeb({
    super.key,
  ...
  @override
  State<AcquistaPianoPageWeb> createState() => _AcquistaPianoPageStateWeb();
}

class _AcquistaPianoPageStateWeb extends State<AcquistaPianoPageWeb> {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 8),
                            FunzioniAttiveForm(
                                funzioniAttive: widget.piano!['funzioni']),
                          ],
                        ),
                      ),
                    ),
